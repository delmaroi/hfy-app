let express,authUser,registerUser;_20d‍.x([["default",()=>_20d‍.o]]);_20d‍.w("express",[["default",["express"],function(v){express=v}]]);_20d‍.w("../controllers/userController",[["authUser",["authUser"],function(v){authUser=v}],["registerUser",["registerUser"],function(v){registerUser=v}]]);

const router = express.Router();

router.route("/api/register").post(registerUser);
router.post("/api/signin", authUser);
